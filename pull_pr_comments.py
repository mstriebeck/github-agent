...
GITHUB_TOKEN = "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"
...
def process_comments():
    ...
    #message_list = []
    print("Please address the following comments:")
    for c in comments:
        body = c["body"]
        ...
        print(f"File: {path} line: {line} - {body}")
        #message_list.append({
        #    "role": "user",
        #    "content": (
