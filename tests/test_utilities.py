...
class TestGitHubURLParsing(unittest.TestCase):
    ...
    def test_parse_ssh_urls(self):
        ...
        test_cases = [
            ...
            ("git@github.com:owner/repo_with_underscores.git", "owner/repo_with_underscores"),
        ]
...
class TestWorkflowRunMatching(unittest.TestCase):
    ...
    def test_partial_commit_match(self):
        ...
        target_commit = "def45600ffffffffffffffffffffffffffffffff"  # Only first 8 match run_2
        result = find_matching_workflow_run(self.sample_runs, target_commit)
    ...
    def test_exact_match_priority(self):
        ...
        runs_with_collision = [
            ...
            {"id": "partial_match", "head_sha": "abc12300000000000000000000000000000000"},
        ]
