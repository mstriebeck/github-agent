...
class MockValidator(AbstractValidator):
    ...
    def __init__(self, name: str, should_fail: bool = False, error_message: str = "Validation failed"):
        self._name = name
...
class TestValidationRegistry:
    ...
    def test_validate_all_with_language_and_service_validators(self):
        ...
        ValidationRegistry.register_language_validator(Language.PYTHON, language_validator)
    ...
    def test_validate_all_with_failing_language_validator(self):
        ...
        validator = MockValidator("python", should_fail=True, error_message="Python validation failed")
        ValidationRegistry.register_language_validator(Language.PYTHON, validator)
    ...
    def test_validate_all_with_failing_service_validator(self):
        ...
        validator = MockValidator("github", should_fail=True, error_message="GitHub validation failed")
        ValidationRegistry.register_service_validator("github", validator)
    ...
    def test_validate_all_stops_on_first_failure(self):
        ...
        ValidationRegistry.register_language_validator(Language.PYTHON, failing_validator)
    ...
    def test_clear_all_validators(self):
        ...
        assert ValidationRegistry.get_language_validator(Language.PYTHON) is language_validator
