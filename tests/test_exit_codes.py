...
class TestExitCodeManager:
    ...
    def test_report_timeout_worker(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Timeout in worker_shutdown after 30.0s")
    ...
    def test_report_timeout_client(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Timeout in client_disconnect after 15.0s")
    ...
    def test_report_timeout_resource(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Timeout in resource_cleanup after 10.0s")
    ...
    def test_report_force_action_client(self, manager, mock_logger):
        ...
        mock_logger.warning.assert_called_once_with("Forced disconnect on client_connection")
    ...
    def test_report_force_action_resource(self, manager, mock_logger):
        ...
        mock_logger.warning.assert_called_once_with("Forced cleanup on resource_handles")
    ...
    def test_report_verification_failure_zombie(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Verification failed: zombie_check - Found 2 zombie processes")
        assert ShutdownExitCode.ZOMBIE_PROCESSES_DETECTED in manager._verification_failures
    ...
    def test_report_verification_failure_port(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Verification failed: port_check - Port 8080 still in use")
    ...
    def test_report_verification_failure_resource(self, manager, mock_logger):
        ...
        manager.report_verification_failure("resource_leak", "Database connections not closed")
        
        mock_logger.error.assert_called_once_with("Verification failed: resource_leak - Database connections not closed")
    ...
    def test_report_verification_failure_generic(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("Verification failed: other_check - Something went wrong")
    ...
    def test_report_system_error_signal(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in signal_handler: Signal handler failed")
    ...
    def test_report_system_error_coordinator(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in shutdown_coordinator: Coordinator failed")
    ...
    def test_report_system_error_worker(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in worker_manager: Worker manager failed")
    ...
    def test_report_system_error_client(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in client_manager: Client manager failed")
    ...
    def test_report_system_error_resource(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in resource_manager: Resource manager failed")
    ...
    def test_report_system_error_generic(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_once_with("System error in unknown_component: Unknown error")
    ...
    def test_determine_exit_code_clean_manual(self, manager, mock_logger):
        ...
        mock_logger.info.assert_called_once_with(f"Exiting with clean manual shutdown: {ShutdownExitCode.SUCCESS_CLEAN_SHUTDOWN}")
    ...
    def test_determine_exit_code_clean_signal(self, manager, mock_logger):
        ...
        mock_logger.info.assert_called_once_with(f"Exiting with clean signal shutdown: {ShutdownExitCode.SUCCESS_SIGNAL_SHUTDOWN}")
    ...
    def test_determine_exit_code_forced_actions(self, manager, mock_logger):
        ...
        mock_logger.warning.assert_called_with(f"Exiting with force action code: {ShutdownExitCode.FORCE_WORKER_TERMINATION.name} ({ShutdownExitCode.FORCE_WORKER_TERMINATION})")
    ...
    def test_determine_exit_code_system_errors(self, manager, mock_logger):
        ...
        mock_logger.error.assert_called_with(f"Exiting with error code: {ShutdownExitCode.WORKER_MANAGER_ERROR.name} ({ShutdownExitCode.WORKER_MANAGER_ERROR})")
    ...
    def test_determine_exit_code_verification_failures(self, manager, mock_logger):
        ...
        mock_logger.critical.assert_called_with(f"Exiting with critical failure code: {ShutdownExitCode.ZOMBIE_PROCESSES_DETECTED.name} ({ShutdownExitCode.ZOMBIE_PROCESSES_DETECTED})")
