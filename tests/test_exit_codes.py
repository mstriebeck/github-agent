...
class TestExitCodeManager:
    ...
    def test_report_timeout_worker(self, manager, test_logger):
    ...
    def test_report_timeout_client(self, manager, test_logger):
    ...
    def test_report_timeout_resource(self, manager, test_logger):
    ...
    def test_report_timeout_port(self, manager, test_logger):
    ...
    def test_report_force_action_worker(self, manager, test_logger):
    ...
    def test_report_force_action_client(self, manager, test_logger):
    ...
    def test_report_force_action_resource(self, manager, test_logger):
    ...
    def test_report_verification_failure_zombie(self, manager, test_logger):
    ...
    def test_report_verification_failure_port(self, manager, test_logger):
    ...
    def test_report_verification_failure_resource(self, manager, test_logger):
    ...
    def test_report_verification_failure_generic(self, manager, test_logger):
    ...
    def test_report_system_error_signal(self, manager, test_logger):
    ...
    def test_report_system_error_coordinator(self, manager, test_logger):
    ...
    def test_report_system_error_worker(self, manager, test_logger):
    ...
    def test_report_system_error_client(self, manager, test_logger):
    ...
    def test_report_system_error_resource(self, manager, test_logger):
    ...
    def test_report_system_error_generic(self, manager, test_logger):
    ...
    def test_determine_exit_code_clean_manual(self, manager, test_logger):
    ...
    def test_determine_exit_code_clean_signal(self, manager, test_logger):
    ...
    def test_determine_exit_code_forced_actions(self, manager, test_logger):
    ...
    def test_determine_exit_code_system_errors(self, manager, test_logger):
    ...
    def test_determine_exit_code_verification_failures(self, manager, test_logger):
    ...
    def test_determine_exit_code_precedence(self, manager, test_logger):
    ...
    def test_determine_exit_code_max_precedence(self, manager, test_logger):
