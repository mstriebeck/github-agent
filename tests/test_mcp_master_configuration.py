...
class TestMCPMasterConfigurationValidation(unittest.TestCase):
    ...
    def test_valid_configuration_loads_successfully(self):
        ...
        self.assertTrue(result, "Valid configuration should load successfully")
    ...
    def test_missing_language_field_fails_validation(self):
        ...
        self.assertFalse(result, "Configuration with missing language should fail to load")
    ...
    def test_missing_python_path_field_fails_validation(self):
        ...
        self.assertFalse(result, "Configuration with missing python_path should fail to load")
    ...
    def test_multiple_missing_fields_fails_validation(self):
        ...
        self.assertFalse(result, "Configuration with multiple missing fields should fail to load")
    ...
    def test_no_auto_assignment_of_missing_fields(self):
        ...
        self.assertEqual(len(master.workers), 0, "No workers should be created when validation fails")
