...
class TestFileHandleManager(unittest.TestCase):
    ...
    def setUp(self):
        self.logger = logging.getLogger(f"test_file_manager_{int(time.time() * 1000000)}")
        self.logger.setLevel(logging.DEBUG)
...
class TestExternalServiceManager(unittest.TestCase):
    ...
    def setUp(self):
        self.logger = logging.getLogger(f"test_service_manager_{int(time.time() * 1000000)}")
        self.logger.setLevel(logging.DEBUG)
...
class TestResourceManager(unittest.TestCase):
    ...
    def setUp(self):
        self.logger = logging.getLogger(f"test_resource_manager_{int(time.time() * 1000000)}")
        self.logger.setLevel(logging.DEBUG)
    ...
    async def test_resource_priority_ordering(self):
        ...
        self.assertEqual(close_order, ["high_priority", "medium_priority", "low_priority"])
