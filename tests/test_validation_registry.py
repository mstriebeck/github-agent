...
from validation_registry import (
    get_validation_registry_status,
    initialize_validation_registry,
)
...
class TestValidationRegistry(unittest.TestCase):
    ...
    def test_get_validation_registry_status_empty(self):
        ...
        expected_status = {"languages": [], "services": [], "total_validators": 0}
    ...
    def test_initialize_validation_registry_with_logger(self):
        ...
        with patch("validation_registry.PythonValidator") as mock_python, patch(
            "validation_registry.GitHubValidator"
        ) as mock_github, patch(
            "validation_registry.CodebaseValidator"
        ) as mock_codebase:
            initialize_validation_registry(self.logger)
    ...
    def test_validation_registry_integration_with_context(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            python_validator = ValidationRegistry.get_language_validator(
                Language.PYTHON
            )
            github_validator = ValidationRegistry.get_service_validator("github")
            codebase_validator = ValidationRegistry.get_service_validator("codebase")
