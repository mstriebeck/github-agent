...
class TestMultiRepositoryIntegration(unittest.TestCase):
    ...
    def test_repository_manager_multi_repo_workflow(self):
        ...
        self.assertEqual(set(repos), {"project-a", "project-b"}, "Should list all repositories")
    ...
    def test_single_repo_fallback_workflow(self):
        ...
        with patch.dict(os.environ, {'LOCAL_REPO_PATH': str(self.repo1_path)}):
            ...
            self.assertFalse(manager.is_multi_repo_mode(), "Should be in single-repo mode")
    ...
    def test_configuration_creation(self):
        ...
        # Verify file exists
        self.assertTrue(new_config_file.exists(), "Configuration file should be created")
        ...
        repos = manager.list_repositories()
        self.assertEqual(set(repos), {"repo1", "repo2"}, "Should have configured repositories")
