...
class TestMCPClient(unittest.TestCase):
    ...
    async def test_send_shutdown_notification(self):
        ...
        success = await client.send_shutdown_notification(DisconnectionReason.SHUTDOWN, 10.0)
    ...
    async def test_client_disconnect_callbacks(self):
        ...
        self.assertIn(('sync', 'test_client', DisconnectionReason.SHUTDOWN), callback_called)
        self.assertIn(('async', 'test_client', DisconnectionReason.SHUTDOWN), callback_called)
...
class TestClientConnectionManager(unittest.TestCase):
    ...
    def test_remove_client(self):
        ...
        success = self.manager.remove_client("client1", DisconnectionReason.CLIENT_REQUEST)
        self.assertTrue(success)
        self.assertEqual(len(self.manager.get_all_clients()), 0)
    ...
    async def test_broadcast_notification(self):
        ...
        results = await self.manager.broadcast_notification("test/method", {"param": "value"})
