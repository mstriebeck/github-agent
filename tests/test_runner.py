...
class TestRunner:
    ...
    def run_performance_tests(self, verbose: bool = False) -> Dict:
        ...
        cmd = [
            ...
            str(self.test_dir),
            "-m", "slow",  # Run tests marked as slow
            "--tb=short",
    ...
    def run_all_tests(self, verbose: bool = False, include_performance: bool = False,
    ...
    def _run_pytest(self, test_path: Path, verbose: bool = False, 
                   timeout: int = 60, test_pattern: str = None) -> Dict:
